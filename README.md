...
> Answer: Client side routing does not refresh all of the content and it does not make another request to the server over the internet. 
- [ ] What does AJAX stand for?
> Answer: Asynchronous
- [ ] What are `controlled components` in React?
> Answer: A React controlled component is controlled with the React DOM and not the browser DOM. 
